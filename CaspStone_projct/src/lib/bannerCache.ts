...
export async function setBannersToCache(banners: Banner[]): Promise<void> {
    await redis.set(ADMIN_BANNERS_CACHE_KEY, JSON.stringify(banners), 'EX', ADMIN_BANNERS_CACHE_TTL_SECONDS)
}
